            ...
            if (data.hourly) {
                ...
                if (item.causeOfLoss === "Drought" || item.causeOfLoss === "Excessive Heat") {
                    idealConditions = {
                        ...
                        Humidity: "< 40%",
                        Rainfall: "< 10mm",
                        WindSpeed: "Not Considered",
                        SoilTemp: "> 25°C",
                    };
                    if (
                        parseFloat(averages.Temperature) > 30 &&
                        parseFloat(averages.Humidity) < 40 &&
                    ...
                    if (
                        parseFloat(averages.Temperature) < 0 &&
                        parseFloat(averages.Rainfall) < 5 &&
                        parseFloat(averages.SoilTemp) < 0
                    ) {
                        status = "Approved";
                        message = "Weather data matches reported loss. Claim is approved.";
                    }
